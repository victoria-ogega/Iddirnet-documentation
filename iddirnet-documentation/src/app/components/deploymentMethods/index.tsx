export default function Deployment() {
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12 font-sans" style={{ fontFamily: "'Nunito', sans-serif", color: '#171717' }}>
            {/* Hero Section - Matching Testing Component Structure */}
            ...
            {/* Deployment Categories - Matching Testing Component Structure */}
