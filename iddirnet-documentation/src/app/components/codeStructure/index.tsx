...
export default function NamingConventions() {
  return (
    <main className="min-h-screen bg-white flex flex-col items-center py-10 px-2 md:px-12">
      <div className="w-full max-w-7xl grid grid-cols-1 md:grid-cols-2 gap-25" style={{ gridAutoRows: '1fr' }}>
        <div className="flex flex-col gap-8">
          <section className="bg-orange-400 text-white xl:w-155 rounded-md border border-[#B88704] p-5 shadow-md h-full">
            <h2 className="text-3xl md:text-4xl font-light mb-4">Frontend</h2>
            <p className="md:text-2xl">Structure & Functions</p>
            <ul className="list-disc pl-6 mb-4 space-y-1 md:text-lg text-base">
              <li>
            ...
            <p className="md:text-2xl">Naming Conventions</p>
            ...
            <p className="md:text-2xl"> Standards</p>
            <ul className="list-disc pl-6 space-y-1 md:text-lg text-base">
              <li>
   ...
   <section className="bg-white text-[#0D3B3A] xl:w-155 rounded-md border border-[#B88704] p-8 shadow-md h-full">
  <h2 className="text-2xl md:text-4xl font-light mb-4 tracking-wide">Mobile</h2>

  <p className="text-xl md:text-2xl">Structure & Functions</p>
  <ul className="list-disc md:text-lg pl-6 mb-4 text-base">
  ...
  <p className="text-xl md:text-2xl">Naming Conventions</p>
  <ul className="list-disc pl-6 mb-4 md:text-lg text-base">
    <li>
  ...
  <p className="text-xl md:text-2xl">Standards</p>
  <ul className="list-disc pl-6 md:text-lg text-base">
  ...
  <li>Type annotations for parameters/returns (e.g., <span className="font-mono">String?</span>, <span className="font-mono">List&lt;User&gt;</span>).</li>
    ...
    <li>Platform-specific best practices (e.g., <span className="font-mono">ViewModel</span> in Jetpack).</li>
        ...
        <div className="flex flex-col gap-8">
<section className="flex items-center justify-center border border-[#B88704] rounded-md bg-white p-5 shadow-md h-full">
  <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#0D3B3A] text-center leading-tight">
    Naming
    <br />
    Conventions &amp;
    <br />
    Coding Standards
         ...
         <section className="bg-[#0b191b] text-white rounded-md border border-cyan-800 p-5 shadow-md h-full">
  <h2 className="text-3xl md:text-4xl font-light mb-4">Backend</h2>
  ...
  <p className="md:text-2xl">Naming Conventions</p>
  <ul className="list-disc pl-6 md:text-lg mb-4 space-y-1 text-base">
    <li>
  ...
  <p className="md:text-2xl">Standards</p>
  <ul className="md:text-lg list-disc pl-6 space-y-1 text-base">
