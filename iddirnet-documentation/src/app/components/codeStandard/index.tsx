    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
        <div className="flex flex-col gap-6 sm:gap-8">
          <section className="bg-[#B88704] text-white rounded-md border border-[#B88704] p-4 sm:p-5 shadow-sm">
        ...
        <div className="flex flex-col gap-6 sm:gap-8">
          <section className="flex items-center justify-center border border-[#B88704] rounded-md bg-white p-6 shadow-sm">
          ...
          <section className="bg-[#00353D] text-white rounded-md border border-cyan-800 p-4 sm:p-5 shadow-sm">
